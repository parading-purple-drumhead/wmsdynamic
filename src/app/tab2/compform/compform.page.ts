...
export class CompformPage implements OnInit {
  ...
  selectFloor(val: any){
    ...
    this.http.post('http://ec2-13-233-247-42.ap-south-1.compute.amazonaws.com:5000/dropfloor', data, {responseType: 'text'}).subscribe(
  ...
  addcomp(form)
  {
    ...
    this.http.post('http://ec2-13-233-247-42.ap-south-1.compute.amazonaws.com:5000/inscomplaint', data, {responseType: 'text'}).subscribe(
