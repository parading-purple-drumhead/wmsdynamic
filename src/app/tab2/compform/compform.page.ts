...
export class CompformPage implements OnInit {
  ...
  selectFloor(val: any){
    ...
    this.http.post('http://ec2-3-6-36-255.ap-south-1.compute.amazonaws.com:5000/dropfloor', data, {responseType: 'text'}).subscribe(
  ...
  addcomp(form)
  {
    ...
    this.http.post('http://ec2-3-6-36-255.ap-south-1.compute.amazonaws.com:5000/inscomplaint', data, {responseType: 'text'}).subscribe(
